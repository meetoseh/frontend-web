...
import styles from './ClientScreenFilterAndSortBlock.module.css';
...
type ClientScreenFilterAndSortBlockProps = {
  /**
...
export const FLAG_NAMES: [ClientScreenFlags, string][] = [
  [ClientScreenFlags.SHOWS_IN_ADMIN, 'Shows in admin'],
  [ClientScreenFlags.SHOWS_ON_BROWSER, 'Shows on web clients'],
  [ClientScreenFlags.SHOWS_ON_IOS, 'Shows within iOS app'],
  [ClientScreenFlags.SHOWS_ON_ANDROID, 'Shows within android app'],
];

const FLAG_PRESETS: [ClientScreenFlags | 0, string][] = [
  [0, 'No Filters'],
  [ClientScreenFlags.SHOWS_IN_ADMIN, 'Shows in admin'],
  [ClientScreenFlags.SHOWS_IN_ADMIN | ClientScreenFlags.SHOWS_ON_BROWSER, 'Shows on web clients'],
  [ClientScreenFlags.SHOWS_IN_ADMIN | ClientScreenFlags.SHOWS_ON_IOS, 'Shows within iOS app'],
  [
    ClientScreenFlags.SHOWS_IN_ADMIN | ClientScreenFlags.SHOWS_ON_ANDROID,
    'Shows within android app',
  ],
  [
    ClientScreenFlags.SHOWS_IN_ADMIN |
      ClientScreenFlags.SHOWS_ON_BROWSER |
      ClientScreenFlags.SHOWS_ON_IOS |
      ClientScreenFlags.SHOWS_ON_ANDROID,
    'Shows everywhere',
  ],
  [
    ClientScreenFlags.SHOWS_IN_ADMIN |
 ...
 */
export const ClientScreenFilterAndSortBlock = ({
  sort: sortVWC,
  filter: filterVWC,
}: ClientScreenFilterAndSortBlockProps): ReactElement => {
  ...
  const flagVWC = useMappedValueWithCallbacks(filterVWC, (filter) => {
    ...
    return flag as ClientScreenFlags;
  });
            ...
            component={(preset) => (
              <select
                ...
                onChange={(e) => {
                  ...
                  const parsed = parseInt(e.target.value) as ClientScreenFlags | 0;
