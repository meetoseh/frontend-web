...
export const CreateJourneyUploadAudioContent = ({
  ...
  useEffect(() => {
    ...
    async function uploadFile() {
      ...
      try {
        fileSha512 = await new Promise<string>(async (resolve, reject) => {
  ...
  return uploadState === 'picking-file' ? (
    <div className={styles.container}>
      ...
      <div className={styles.help}>
        Our servers will compress the file into several formats, which will ensure every device gets
        the best possible experience. This works best if the uploaded audio files are uploaded with
        2 channels at 44.1 kHz, with 24-bit depth and a bitrate of 2116.8 kbps. At these settings,
        the file size should be around 265 Kb/second, or just under 16 Mb for a 60 second file.
      </div>
